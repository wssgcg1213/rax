...
export default class MainLogo extends Component {
  ...
  render() {
    return (
      <div className="site-main-logo2">
        <div className="deco" aria-hidden="true"></div>
        <div className="logo2" aria-hidden="true">
          <svg id="rx-logo" width="70px" height="70px" viewBox="0 0 502 500">
        ...
        <div className="site-main-title2">跨容器的渲染引擎</div>
        <div className="site-main-title-m2">Write Once, Run everywhere!</div>
        <div className="site-btns2">
          <Link className="button" to={'/guide/getting-started'}>快速开始</Link>
        </div>
      </div>
    );
  }
